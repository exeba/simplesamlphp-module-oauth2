...
$config = [
     ...
     */
    'database.dsn' => 'sqlite:////'.dirname(__DIR__).'/simplesamlphp.sqlite',
     ...
     */
    'database.prefix' => 'SimpleSAMLphp_',
     ...
     */
    #'store.type'                    => 'SimpleSAML\Module\dbal\Store\DBAL',
